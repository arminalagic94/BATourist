...
<li class="dropdown-header"><b>Zimovanje</b></li>
            <li class="active"><a href="zimovanje_afrika.php">Afrika</a></li>
	  ...
	  <span class="glyphicon glyphicon-user" aria-hidden="true" style="float:right; padding-top:11px; font-size:16px; color:white;"> <a href="odjava.php" style="color:white; font-size:22px; text-decoration: none;">ODJAVA</a></span>
		...
		?>
    <?php 
        $sql1="select * from aranzmani where stanje=1 and akcija=0 and tip='Zimovanje' and kontinent='Afrika' and id_aranzman not in(select id_aranzmana from rezervacije where id_klijenta='$id_klijent')";
...
<table class="table">
  ...
  <div class="carousel-inner" role="listbox">
	...
	<tbody><tr><th><form action="zimovanje_afrika.php" method="POST"><button class="btn btn-primary" type="submit" name="btn" value="<?php echo $row['id_aranzman']?>">Rezerviši</button></form></th><td></td></tr>
</tbody>
