...
<table class="table" style="background-color:#e6f2ff;">
    ...
    <?php 
        ...
        $sql1="select * from klijent where id_klijent='$id_klijent'";
...
<a href="uredi_profil.php"><input class="btn btn-primary" type="submit" name="uredi" value="Uredi"/></a>
...
<table class="table">
  ...
  <div class="carousel-inner" role="listbox">
	...
	<tbody><tr><th><form action="moj_profil.php" method="POST"><button class="btn btn-primary" type="submit" name="btn" value="<?php echo $row['id_aranzman']?>">Rezerviši</button></form></th><td></td></tr>
</tbody>
