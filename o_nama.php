  ...
  <a href="#"></a>
	...
	<div style="padding-top:5px;; text-align:center;">
      ...
      <ul class="nav navbar-nav" style="font-size:22px;">
		...
		<li class="active"><a href="o_nama.php">O NAMA </a></li>
...
<li class="dropdown-header"><b>Zimovanje</b></li>
	  ...
	  <span class="glyphicon glyphicon-user" aria-hidden="true" style="float:right; padding-top:11px; font-size:16px; color:white;"> <a href="odjava.php" style="color:white; font-size:22px; text-decoration: none;">ODJAVA</a></span>
		...
		<div class="container-fluid">
			...
			<img src="images/lg5.jpg" style="width:20%; height:auto;">
		
			<h1 style="text-align:center;">BA - Tourist Info</h1>
			<div>
			<p>
			<span class="glyphicon glyphicon-envelope" aria-hidden="true" style="text-valign:center; font-size:18px; padding:10px;">  info@batourist.ba  </span>
			<span class="glyphicon glyphicon-phone" aria-hidden="true" style="text-valign:center; font-size:18px; padding:10px;">  387 (0)62 111 222</span>
			<span class="glyphicon glyphicon-user" aria-hidden="true" style="text-valign:center; font-size:18px; padding:10px;">  www.facebook.com/batouristagency</p>
			</div>
			</div>
			
			<p style="text-align:justify; font-size:22px;">BA Turistička putnička agencija je privatni prodavač ili javni servis koji pruža putovanja i turističke usluge vezane za javnost kao što su razne aktivnosti, airlines, iznajmljivanje automobila, cruise linije, hoteli, željeznice, putno osiguranje, kao i paket aranžmane. Osim bave običnim turistima većina turističkih agencija imaju zaseban odjel posvećen izradi aranžmana za poslovne putnike i nekih putničkih agencija specijalizirana samo u komercijalne i poslovnih putovanja. Tu su i turističke agencije koje služe kao opće prodajnih agenata stranih turističkih tvrtki, dopuštajući im da imaju urede u drugim zemljama gdje se nalaze njihovi sjedište.</p>
...
<table class="table">
  ...
  <div class="carousel-inner" role="listbox">
	...
	<tbody><tr><th><form action="o_nama.php" method="POST"><button class="btn btn-primary" type="submit" name="btn" value="<?php echo $row['id_aranzman']?>">Rezerviši</button></form></th><td></td></tr>
</tbody>
