...
<body style="background: url('images/bg/k.jpg');background-size:cover; background-repeat: no-repeat; max-width:100%; height:900px;">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="max-width:100%; margin-left:21%;">
      ...
      <ul class="nav navbar-nav" style="font-size:26px;">
        ...
        <li class="active"><a href="izvjestaj.php">IZVJEŠTAJ <span class="sr-only">(current)</span></a></li>
...
<table class="table" style="font-size:18px; background-color:#e6f2ff;">
    ...
    <?php 
        $sql1="select * from izvjestaj order by prihod asc";
 ...
 <td><?php
			...
			echo $row2["naziv_destinacije"];
		?></td>
	    <td><?php echo $row['br_rezervacija'] ?></td>
	    <td><?php echo $row['prihod'] ?> €</td> 
        </tr>
