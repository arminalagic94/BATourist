      ...
      <ul class="nav navbar-nav" style="font-size:26px;">
		...
		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
		    ...
		    <li class="active"><a href="lista_dobitnika_z.php">Lista dobitnika</a></li>			
			</ul>			
	        </li>
      </ul>
...
<table class="table" style="font-size:18px; background-color:#e6f2ff;">
    <thead style="background-color: #b3d6ff;">
     ...
     <?php 
        $sql1="select * from izvjestaj_kviza";
    ...
    ?>
        <tr>
 <td><?php
			$sql2="select * from kviz where id_kviz='$row[id_kviza]'";
 ...
 <td><?php
			$sql22="select * from aranzmani where id_aranzman='$row[id_aranzmana]'";
			$query22=mysql_query($sql22);
			$row2 = mysql_fetch_array($query22); 
			echo $row2["naziv_destinacije"];
		?></td>		
		
	    <td><?php echo $row['br_ucesnika'] ?></td> 
        </tr>
