<?php
  ...
  $id_klijent=$_POST["id_klijent"];
	...
	{
			$sql5="delete from klijent where id_klijent='$id_klijent'";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="max-width:100%; margin-left:21%;">
      ...
      <ul class="nav navbar-nav" style="font-size:26px;">
		...
		<li class="active"><a href="lista_klijenata_z.php">KLIJENTI</a></li>
...
<table class="table" style="font-size:18px; background-color:#e6f2ff;">
    ...
    <?php 
        $sql1="select * from klijent order by ime asc";
    ...
    ?>
        <tr>
		<td><input type="radio" name="id_klijent" value="<?php echo $row['id_klijent']; ?>"></td>
