<?php
  ...
  if(!isset($_SESSION['id'])){
	...
	if(isset($_POST["btn"]))
	{
		...
		$sql2="UPDATE aranzmani SET akcija=0 WHERE id_aranzman='$id_aranzman'";
...
<nav class="navbar navbar-inverse" style="max-width:100%; background-color:black;">
  <div class="container-fluid">
      ...
      <ul class="nav navbar-nav" style="font-size:26px;">
		...
		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
			...
			<li class="active"><a href="zavrsi_akciju.php">Završi akciju</a></li>
	...
	<div class="col-md-offset-3 col-md-6 col-md-offset-3" style=" background-color:#e6f2ff;">
		...
		<div style="font-size:18px; text-align:center; background-color: #b3d6ff;"><h2><b>ZAVRŠI AKCIJU</b></h2></div>
				...
				<div class="form-group">
					...
					<select class="form-control" name="id_aranzman" ></li>
						<?php
							...
							$sql2="select * from aranzmani where akcija=1";
							$query2=mysql_query($sql2);
