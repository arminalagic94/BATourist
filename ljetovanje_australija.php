...
<li class="dropdown-header"><b>Ljetovanje</b></li>
            ...
            <li class="active"><a href="ljetovanje_australija.php">Australija</a></li>	
...
<li class="dropdown-header"><b>Zimovanje</b></li>
    ...
    <?php 
        $sql1="select * from aranzmani where stanje=1 and akcija=0 and tip='Ljetovanje' and kontinent='Australija' and id_aranzman not in(select id_aranzmana from rezervacije where id_klijenta='$id_klijent')";
...
<table class="table">
  ...
  <div class="carousel-inner" role="listbox">
	...
	<tr style="background-color:#e6faff;"><th>Cijena</th> <td><?php echo $row['cijena'] ?> €</td></tr>
	<tr style="background-color:#e6faff;"><th>Ponuda</th> <td><?php echo Redovna; ?></td></tr>
	<tr style="background-color:#e6faff;"><th >Opis</th> <td><textarea style="background-color:#e6faff"><?php echo $row['opis'] ?></textarea></td></tr>
    </thead>
	<tbody><tr><th><form action="ljetovanje_australija.php" method="POST"><button class="btn btn-primary" type="submit" name="btn" value="<?php echo $row['id_aranzman']?>">Rezerviši</button></form></th><td></td></tr>
</tbody>
