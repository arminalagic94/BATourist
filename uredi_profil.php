...
<li class="dropdown-header"><b>Zimovanje</b></li>
	  ...
	  <span class="glyphicon glyphicon-user" aria-hidden="true" style="float:right; padding-top:11px; font-size:16px; color:white;"> <a href="odjava.php" style="color:white; font-size:22px; text-decoration: none;">ODJAVA</a></span>
		...
		<div class="col-md-offset-4 col-md-4 col-md-offset-4" style=" background-color:#e6f2ff;">
    ...
    <?php 
		...
		$br_pasosa=$_POST["br_pasosa"];	
		
		$sql2="update klijent set ime='$ime', prezime='$prezime', adresa='$adresa', br_tel='$br_tel', grad='$grad', br_pasosa='$br_pasosa', datum_rodjenja='$datum_rodjenja', username='$username', password='$password' where id_klijent='$id_klijent'";
		...
		<div style="font-size:18px; text-align:center; background-color: #b3d6ff;"><h2><b>UREDI PROFIL</b></h2></div>
		
		<form method="POST" style="padding-top:10px; padding-bottom:10px; padding-left:5px; padding-right:5px;">
			<div class="form-body pal">
			
				<div class="form-group"><input class="form-control" type="text" name="ime" placeholder="Unesite ime"/></div>

				<div class="form-group"><input class="form-control" type="text" name="prezime" placeholder="Unesite prezime"/></div>
				
				<div class="form-group"><input class="form-control" type="text" name="username" placeholder="Unesite username"/></div>
				
				<div class="form-group"><input class="form-control" type="text" name="password" placeholder="Unesite password"/></div>
				
				<div class="form-group"><input class="form-control" type="text" name="grad" placeholder="Unesite grad"/></div>
				
				<div class="form-group"><input class="form-control" type="text" name="adresa" placeholder="Unesite adresu"/></div>

				<div class="form-group"><input class="form-control" type="text" name="email" placeholder="Unesite email "/></div>
				
				<div class="form-group"><input class="form-control" type="text" name="br_tel" placeholder="Unesite br telefona"/></div>
				
				<div class="form-group"><input class="form-control" type="text" name="datum_rodjenja" placeholder="Unesite datum rođenja (god-mj-dan)"/></div>
				
				<div class="form-group"><input class="form-control" type="text" name="br_pasosa" placeholder="Unesite br pasoša"/></div>
				
			</div>
			
			<div class="form-actions pal">
				<input class="btn btn-primary" type="submit" name="btn" value="Spremi"/>
				<input class="btn btn-primary" type="reset" name="btn1" value="Odustani"/>
			</div>
		</form>
...
<table class="table">
  ...
  <div class="carousel-inner" role="listbox">
	...
	<tbody><tr><th><form action="uredi_profil.php" method="POST"><button class="btn btn-primary" type="submit" name="btn" value="<?php echo $row['id_aranzman']?>">Rezerviši</button></form></th><td></td></tr>
</tbody>
