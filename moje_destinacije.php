...
<table class="table" style="background-color:#e6f2ff;">
    ...
    <?php
		$id_klijent=$_SESSION['id'];
        $sql1="select * from moje_destinacije where id_klijenta='$id_klijent'";
    ...
    ?>
        <tr>
		<td><?php			
			$sql3="select * from aranzmani where id_aranzman='$row[id_aranzmana]'";
		    $query6=mysql_query($sql3);
			$row1 = mysql_fetch_array($query6);
			echo $row1['naziv_destinacije']; ?></td> 
		<td><?php echo $row1['drzava'] ?></td>
		<td><?php echo $row1['datum_polaska']; ?></td>
        <td><?php echo $row1['cijena']; ?> €</td>
        </tr>
...
<table class="table">
  ...
  <div class="carousel-inner" role="listbox">
	...
	<tbody><tr><th><form action="moje_destinacije.php" method="POST"><button class="btn btn-primary" type="submit" name="btn" value="<?php echo $row['id_aranzman']?>">Rezerviši</button></form></th><td></td></tr>
</tbody>
