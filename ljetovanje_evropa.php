...
<li class="dropdown-header"><b>Ljetovanje</b></li>
            ...
            <li class="active"><a href="ljetovanje_evropa.php">Evropa</a></li>	
			<li role="separator" class="divider"></li>
<li class="dropdown-header"><b>Zimovanje</b></li>
    ...
    <?php 
        $sql1="select * from aranzmani where stanje=1 and akcija=0 and tip='Ljetovanje' and kontinent='Evropa' and id_aranzman not in(select id_aranzmana from rezervacije where id_klijenta='$id_klijent') ";
...
<table class="table">
  ...
  <div class="carousel-inner" role="listbox">
	...
	<tbody><tr><th><form action="ljetovanje_evropa.php" method="POST"><button class="btn btn-primary" type="submit" name="btn" value="<?php echo $row['id_aranzman']?>">Rezerviši</button></form></th><td></td></tr>
</tbody>
