...
<body style="background: url('images/bg/bg.jpg'); max-width:100%; height:1200px;">
...
<div class="col-md-12">
	<img src="images/logo.jpg" alt="LOGO" style="height:200px; width:340px; float:left;">

	<img src="images/banner.png" alt="LOGO" style="height:200px; width:1193px;">
	
	<img src="images/logo.jpg" alt="LOGO" style="height:200px; width:340px; float:right;">
</div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="max-width:100%; margin-left:21%;">
      ...
      <ul class="nav navbar-nav" style="font-size:22px;">
		...
		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
			<li><a href="lista_kvizova.php">Lista kvizova</a></li>
			<li><a href="dodaj_kviz.php">Dodaj kviz</a></li>
		    <li class="active"><a href="lista_ucesnika.php">Lista učesnika</a></li>
      ...
      <form class="navbar-form navbar-left">
        <div class="form-group">
          <input type="text" class="form-control" placeholder="" style="width:180px;">
        </div>
        <button type="submit" class="btn btn-default" style="width:40px;"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
      </form>
...
<table class="table">
    ...
    ?>
        <tr>
        <td><?php echo $row['id_ucesnik'] ?></td>
	    <td><?php
			$sql3="select * from kviz where id_kviz='$row[id_kviz]'";
		    $query6=mysql_query($sql3);
			$row1 = mysql_fetch_array($query6);
			
			echo $row1['pitanje'] ;
			
		?></td>
	    <td><?php 	$sql4="select * from klijent where id_klijent='$row[id_klijent]'";
