      ...
      <ul class="nav navbar-nav" style="font-size:22px;">
		...
		<li class="dropdown" class="active">
          ...
          <ul class="dropdown-menu">
		    <li class="active"><a href="akcijska.php">Akcijska putovanja</a></li>
...
<li class="dropdown-header"><b>Zimovanje</b></li>
	  ...
	  <span class="glyphicon glyphicon-user" aria-hidden="true" style="float:right; padding-top:11px; font-size:16px; color:white;"> <a href="odjava.php" style="color:white; font-size:22px; text-decoration: none;">ODJAVA</a></span>
		...
		<div class="col-md-offset-2 col-md-8 col-md-offset-2" style="padding:10px;" >
		...
		?>
		    ...
		    <?php 
        $sql1="select * from aranzmani where stanje=1 and akcija=1 and id_aranzman not in(select id_aranzmana from rezervacije where id_klijenta='$id_klijent')";
...
<table class="table">
  ...
  <div class="carousel-inner" role="listbox">
	...
	<tr style="background-color:#e6faff;"><th>Cijena</th> <td><?php echo $row['akcijska_cijena'] ?> €</td></tr>
	<tr style="background-color:#e6faff;"><th>Ponuda</th> <td><?php echo Akcija; ?></td></tr>
	<tr style="background-color:#e6faff;"><th >Opis</th> <td><textarea style="background-color:#e6faff"><?php echo $row['opis'] ?></textarea></td></tr>


	</thead>
	<tbody><tr><th><form action="akcijska.php" method="POST"><button class="btn btn-primary" type="submit" name="btn" value="<?php echo $row['id_aranzman']?>">Rezerviši</button></form></th><td></td></tr>
</tbody>
